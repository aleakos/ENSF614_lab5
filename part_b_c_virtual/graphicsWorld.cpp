...
/****************************ASSUME CODE SEGMENT FOR EXERCISE A IS HERE ************************/
    ...
    sh2[3] = &rc;
    sh2[0]->display();
    cout << "\nthe area of " << sh2[0]->getName() << " is: " << sh2[0]->area() << endl;
    cout << "\nthe perimeter of " << sh2[0]->getName() << " is: " << sh2[0]->perimeter() << endl;
    sh2[1]->display();
    cout << "\nthe area of " << sh2[1]->getName() << " is: " << sh2[1]->area();
    cout << "\nthe perimeter of " << sh2[0]->getName() << " is: " << sh2[1]->perimeter() << endl;
    sh2[2]->display();
    cout << "\nthe area of " << sh2[2]->getName() << " is: " << sh2[2]->area();
    cout << "\nthe circumference of " << sh2[2]->getName() << " is: " << sh2[2]->perimeter() << endl;
    sh2[3]->display();
    cout << "\nthe area of " << sh2[3]->getName() << " is: " << sh2[3]->area() << endl;
    cout << "\nthe perimeter of " << sh2[3]->getName() << " is: " << sh2[3]->perimeter() << endl;
